...
| `days_to_ymd(days: i64) -> (i32, u32, u32)` | Hinnant algorithm: days-since-epoch → `(year, month, day)` |
| `enumerate_drives() -> Vec<DriveInfo>` | Lists system drives via `sysinfo`; normalizes Windows drive letters |
